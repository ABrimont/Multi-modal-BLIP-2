...
class Blip2T5_separate(Blip2Base):
    ...
    def __init__(
        ...
        self.Qformer, self.query_tokens = self.init_Qformer(32, 1408, cross_attention_freq=2)
        self.Qformer_aud, self.query_tokens_aud = self.init_Qformer(16, 768, cross_attention_freq=2)
