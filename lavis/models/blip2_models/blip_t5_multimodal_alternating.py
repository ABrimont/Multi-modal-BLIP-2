...
from .blip2_multimodal_QFormer_alternate import init_Qformer_dual
...
@registry.register_model("blip2_t5_multimodal_alternating")
class Blip2T5_multimodal_alternating(Blip2Base):
    """
    BLIP2 T5 model.
